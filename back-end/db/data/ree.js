export default [
  ...
  },
  {
    ...
    prepTime: '20 mins',
    cookingTime: '1 hour and 30 mins',
    difficulty: 'Easy',
    servingSize: 4,
  ...
  },
  {
    ...
    image: 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/protein-4923259.jpg',
    ...
    ingredients: ['2 tbsp ground flaxseeds', '20g ground almonds', '300ml soya milk', '200g quinoa flour', '1 medium banana , mashed',
      '2 tbsp maple syrup', 'coconut oil , for frying', '200g blueberries , mashed', '2 tbsp chia seeds', '1-2 tbsp maple syrup , to taste', '2 tsp lemon juice', 
      '100g coconut yogurt or Greek yogurt', '1 tbsp pistachio nuts or pumpkin seeds, chopped, toasted if you like', '2 tsp hulled hemp seeds', 'mixed berries' ],
    method: [ 'In a small bowl stir the flaxseeds with 6 tbsp water and set aside to soak while you make the jam.', 
  ...
  },
  {
    ...
    image: 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-1308531_3-ff9aca0.jpg',
    description: 'A ruby-red iced dessert with subtle floral hints – a refreshing end to spicy meals.',
    ingredients: ['300g caster sugar', '900g ripe strawberry , hulled', 'juice 1 lemon', '2 tsp - 2tbsp (depending on strength) rosewater', 'handful pink rosé petals, to serve (optional)' ],
    method: [ 'In a medium pan, combine the sugar with 300ml water. Let the sugar dissolve, then bring to the boil for 1 min. Put the strawberries in a blender or food processor and pulse until smooth. Trickle in the sugar syrup, blend again, then add the lemon juice and rose water.', 
  ...
  },
  {
    ...
    image: 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/slow-cooker-ratatouille-4ecd407.jpg',
    ...
    ingredients: ['2 tbsp olive oil', '1 red onion , sliced', '2 garlic cloves', '2 large aubergines , cut into 1.5cm pieces', '3 courgettes , halved and cut into 2cm pieces', 
      '3 mixed peppers , cut into 2cm pieces', '1 tbsp tomato purée', '6 large ripe tomatoes , roughly chopped', 'small bunch of basil , roughly chopped, plus a few extra leaves to serve', 
      'few thyme sprigs', '400g can plum tomatoes', '1 tbsp red wine vinegar', '1 tsp brown sugar', 'sourdough , to serve (optional)' ],
    method: [ 'Heat the oil in a large frying pan and fry the onion for 8 mins until translucent. Add the garlic and fry for 1 min. Turn the heat to medium-high, add the aubergines and fry for 5 mins until golden. Stir in the courgettes and peppers and fry for 5 mins more until slightly soft. Add the tomato purée, fresh tomatoes, herbs, canned tomatoes, vinegar, sugar and 1 tsp salt and bring to the boil.', 
    ...
    prepTime: '10 mins',
    cookingTime: '6 hours and 20 mins',
    difficulty: 'Easy',
    servingSize: 6,
  ...
  },
  {
    ...
    ingredients: ['400g can chickpeas, rinsed and drained', '1 small red onion, roughly chopped', '1 garlic clove, chopped', 'handful of flat-leaf parsley or curly parsley', '1 tsp ground cumin', 
      '1 tsp ground coriander', '½ tsp harissa paste or chilli powder', '2 tbsp plain flour', '2 tbsp sunflower oil', 
      'toasted pitta bread, to serve', '200g tub tomato salsa, to serve', 'green salad, to serve' ],
    method: [ 'Drain the chickpeas and pat dry with kitchen paper. Tip into a food processor along with the onion, garlic, parsley, cumin, coriander, harissa paste, flour and a little salt. Blend until fairly smooth, then shape into four patties with your hands.', 
    ...
    difficulty: 'Easy',
    servingSize: 4,
    nutritionalInfo: ['kcal: 161', 'fat: 8g', 'saturates: 1g', 'carbs: 18g', 'sugar: 16g', 'fibre: 1g', 'protein: 6g', 'salt: 0.4g'],
    tags: ['burger', 'vegan', 'falafel' ,'pitta', 'lunch'],
    course: 'Main',
    allergens: ['Vegan', 'Vegetarian', 'Dairy-free', 'Egg-free']
  },
  {
    name: 'Vegan fajitas',
    image: 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/vegan-fajitas-ad1ecfa.jpg',
    ...
    ingredients: ['1 tbsp vegetable oil', '2 red or yellow peppers , cut into strips', '1 red onion , sliced', '1 garlic clove , crushed', '½ tsp chilli powder or chilli flakes', 
      '½ tsp smoked paprika', '½ tsp ground cumin', '1 lime , juiced', '400g can black beans , rinsed and drained', 
      'small bunch coriander , finely chopped', '4 large or 8-12 small tortillas', '1 avocado , sliced', 'dairy free yogurt , to serve (optional)' ],
    method: [ 'Heat the oil in a frying pan and fry the peppers and onions over a medium high heat until tender and starting to turn golden brown, about 6-8 mins. Add the garlic and spices and fry for 1 min more until fragrant. Add half of the lime juice and season. Transfer to a serving dish and keep warm while you heat the beans.', 
    ...
    difficulty: 'Easy',
    servingSize: 4,
    nutritionalInfo: ['kcal: 352', 'fat: 12g', 'saturates: 3g', 'carbs: 44g', 'sugar: 7g', 'fibre: 11g', 'protein: 11g', 'salt: 1.29g'],
    tags: ['fajitas', 'vegan', 'lunch'],
    course: 'Main',
    allergens: ['Vegan', 'Vegetarian', 'Dairy-free', 'Egg-free']
  },
  {
    name: 'Pani puris',
    image: 'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/pan-puris-fd82b2c.jpg',
    description: 'This deep-fried Indian street food makes a great party snack – crisp rounds of bread filled with chickpeas and potato, drizzled with a herb and spice water.',
    ingredients: ['150g chakki atta (chapatti flour)', '30g fine semolina', '1l vegetable oil , for puris and deep-frying', '50g bunch coriander', '25g bunch mint', '5g fresh ginger', 
      '2 green chillies', '2 tbsp tamarind pulp', '500ml chilled water', '1 tsp ground cumin', '2 tsp red chilli flakes', '¼ tsp asafoetida',
      '400g canned chickpeas', '¼ tsp asafoetida', '2 large potatoes , peeled and diced into 1cm cubes', '1 tsp ground cumin', '1 medium red onion , finely chopped', 'small bunch coriander including stalks, finely chopped', 
      'juice of 1/2 lemon', '1 small packet of sev (spiced crunchy noodles - available from Indian shops and Amazon)', '200g pomegranate seeds' ],
    method: [ 'Make the pani water. Place the coriander, mint, ginger, green chillies and tamarind pulp in a blender and blitz into a paste. Place in a water jug and add the chilled water and remaining ingredients. Mix well and chill in the fridge for at least 2 hours.', 
    ...
    prepTime: '1 hour and 10 mins',
    cookingTime: '40 mins (plus 2 hours resting)',
    difficulty: 'Hard',
    servingSize: 4 - 6,
    nutritionalInfo: ['kcal: 385', 'fat: 20g', 'saturates: 1g', 'carbs: 39g', 'sugar: 3g', 'fibre: 7g', 'protein: 8g', 'salt: 0.2g'],
